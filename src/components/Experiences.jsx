        ...
        <div className='flex flex-col justify-center items-center w-full h-full'>
            <div className='max-w-[1000px] w-full px-4 grid grid-cols-2 gap-8'>
             ...
             <div className='sm:text-right text-1xl font-bold'>
                    <p className='sm:text-right text-2xl text-[#8892b0]' >Amazon</p>
             ...
             <div className='sm:text-right text-1xl font-bold'>
                    <p className='sm:text-right text-2xl text-[#8892b0]' >Hack4Impact-UMD</p>
                    <p>Technical Lead</p>
                ...
                <div>
                    <ul>
                        <li>
                        • Led a group of software developers to design a data management web application for the non-profit
organization JABA(Jefferson Area Board For Aging) using the MERN stack.

                        </li>
                        <li>
                        • Led a group of software developers to design a data visualization tool for the non-profit
organization PNAA(Philippine Nurses Association of America). 

                        </li>

                        <li>
                        • Assigned engineering tasks and upheld code quality through code review.
                        </li>
                        <li>
                        • Responsible for scoping the technical direction of the project and providing technical guidance for software
engineers and designers.
                        </li>
                        <li>
                        • Coordinated with product managers as well as non-profit representatives to discuss project progressions.
                        </li>
                    </ul>
